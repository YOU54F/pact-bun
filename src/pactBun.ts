...
export class PactBun {
  private ffi: typeof Pact;
  private version: string;
  private appName = "pact-bun";
  ...
  public getPactFfiVersion() {
    this.version = this.ffi.pactffi_version();
    return this.version;
  }
  ...
  public checkMatches() {
    if (this.mockServerPort) {
      ...
      if (!this.matched) {
        ...
        if (mismatches) {
          this.logMessage("pactffi_mock_server_mismatches: " + mismatches);
  ...
  public async executeTest(callback: () => Promise<void>) {
    ...
    if (this.mockServerPort) {
      ...
      if (this.matched) {
        ...
        console.debug("show you da mismatches", this.mismatches);
